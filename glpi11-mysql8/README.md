# madminhu/glpi11-mysql

Dockerizált [GLPI 11](https://glpi-project.org/) IT eszközkezelő rendszer, MySQL 8.0 adatbázishoz optimalizálva. Az image mindig a legújabb stabil GLPI 11.x verziót tartalmazza.
...
services:
  glpi11:
    image: madminhu/glpi11-mysql:latest
    ports:
      - "80:80"
    environment:
      MARIADB_HOST: mysql
